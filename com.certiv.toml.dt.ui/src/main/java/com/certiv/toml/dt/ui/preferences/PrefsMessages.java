 ...
 *******************************************************************************/
package com.certiv.toml.dt.ui.preferences;

import org.eclipse.osgi.util.NLS;

public class PrefsMessages extends NLS {

	private static final String BUNDLE_NAME = "com.certiv.toml.dt.ui.preferences.PrefsMessages";//$NON-NLS-1$

	private PrefsMessages() {}

	static {
		NLS.initializeMessages(BUNDLE_NAME, com.certiv.toml.dt.ui.preferences.PrefsMessages.class);
	}
